                            ...
                            <div class="col-lg-5">
                                <div class="card h-100">
                                    <div class="card-body text-center d-flex flex-column justify-content-center">
                                        <?php if (isset($continuing_project_id) && $continuing_project_id): ?>
                                            <!-- Continuing Project Display -->
                                            <div id="continuingProjectDisplay">
                                                <i class="material-symbols-rounded text-info" style="font-size: 3rem;">refresh</i>
                                                <h5 class="font-weight-bolder mt-2 text-info">Continuing Project</h5>
                                                <h6 class="font-weight-bold text-dark" id="continuingProjectNameText"><?= htmlspecialchars($continuing_project_name); ?></h6>
                                                <p class="mb-2 text-sm text-secondary">Session data will be combined</p>
                                                <button id="startContinuingBtn" class="btn btn-success btn-sm">Ready to Start</button>
                                                <button id="cancelContinuingBtn" class="btn btn-outline-secondary btn-sm mt-2">Cancel & Create New</button>
                                            </div>
                                        <?php else: ?>
                                            <!-- Regular Preview Name Form -->
                                        ...
                                        <!-- Preview Name Display (shared untuk both cases) -->
                                        <div id="adminPreviewNameDisplay" style="display: none;">
                                            ...
                                            <p class="mb-1 text-sm text-secondary">Active Preview Name</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- ============================================ -->
<!-- SCRIPTS SECTION - JANGAN UBAH URUTAN! -->
<!-- ============================================ -->

<!-- Chart.js Library + Plugin -->
...
<!-- AppConfig Object - Bridge PHP to JavaScript -->
<script>
    const AppConfig = {
        baseUrl: '<?= base_url(); ?>',
        csrf: {
        ...
        continuingProject: <?php if (isset($continuing_project_id) && $continuing_project_id): ?> {
                id: <?= $continuing_project_id; ?>,
                name: '<?= addslashes($continuing_project_name); ?>',
                data: <?= json_encode($continuing_project_data); ?>
            }
