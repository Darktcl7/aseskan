<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?= base_url($this->session->userdata('role')); ?>" class="btn btn-outline-primary btn-sm mb-0">
            <i class="material-symbols-rounded" style="font-size: 1rem; vertical-align: middle; margin-right: 4px;">arrow_back</i>
            Kembali
        </a>
    </div>
